...
def test_nested__name_multi_level_wildcard(repo: TagRepo):
    assert repo.query("funny::**") == ["funny::fail",
                                        "funny::video",
                                        "funny::joke",
                                        "funny::fail::injury",
                                        "funny::joke::video",
...
def test_mpq__and(repo: TagRepo):
    assert repo.query("*::{!fail&!pop}") == ["funny::video", "funny::joke", "science::biology"]
